    ...
    <?php
             ...
             <section class="text-center">
               <div class="row py-lg-5" style="margin-right:0px;">
                 <div class="col-lg-6 col-md-8 mx-auto">';
                   ...
                   echo '
                   <h1 class="fw-light">Výpis objednávek</h1>
                   <p class="lead text-muted">
                      V této sekci najdete kompletní výpis objednávek. U každé objednávky máte možnost přijmutí či zamítnutí, která následně automaticky zasílá zpětnou vazbu odesílateli objednávky. Další možnosti úprav naleznete po rozkliknutí přímé objednávky pod "název úkolu"
                   </p>
                 </div>
               </div>
             </section>
                   ...
                   <div class="panel panel-default panel-table">
                     ...
                     <div class="panel-body table-responsive">
                       <table class="table table-striped table-bordered table-list">
                         ...
                         $sql = "SELECT * FROM `objednavkySklad` ORDER BY id DESC LIMIT 10 OFFSET $pomStrana;";
                     ...
                     <div class="panel-footer">
                       ...
                       <nav aria-label="Page navigation example" style="float:right;">
                         ...
                         else if($cisloStrana > 1)
                         {
                           echo '
                           <li class="page-item">
                             <a class="page-link" href="objednavky?sty'.($cisloStrana-1).'">Předchozí</a>
                           </li>';
                         }
                         else {
                           //zajistuje ze se nelze vracet do minus hodnot
                        ...
                        $sqlu = "SELECT * FROM objednavkySklad";
     					...
     					$pomKontrola=0;
                        if($cisloStrana == 1)
     						echo '<li class="page-item disabled"><a class="page-link" href="objednavky?sty">1</a></li>';
                        else if($cisloStrana == "")
                            echo '<li class="page-item disabled"><a class="page-link" href="objednavky?sty1">1</a></li>';
                        else
                            echo '<li class="page-item"><a class="page-link" href="objednavky?sty1">1</a></li>';
    
     					for ($i = 2; $i <= $_SESSION['pocetStran']; $i++) {
                          if($cisloStrana == $i)
     						echo '<li class="page-item disabled"><a class="page-link" href="objednavky?sty'.$i.'">'.$i.'</a></li>';
                          else
                            echo '<li class="page-item"><a class="page-link" href="objednavky?sty'.$i.'">'.$i.'</a></li>';
     					  $pomKontrola=$i;
     					}
                        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
                        ...
                        else if($cisloStrana == "" || $cisloStrana=="?smazaniUkolu=uspesne" || $cisloStrana=="?smazaniUkolu=neuspesne" || $cisloStrana =="?editace==uspesna" || $cisloStrana =="?editace==neuspesna")
                        {
                          ...
                          echo '<li class="page-item">
                                  <a class="page-link" href="objednavky?sty'.($cisloStrana+1).'">Další</a>
                                </li>';
                        }
                         echo '
                         </ul>
     ...
     else
     {
       ...
       $pocetObjednavek=mysqli_num_rows($vys);
         ...
         if($_SESSION['poziceUzivatele'] == "Skladník" || $_SESSION['poziceUzivatele'] == "Šéf" || $_SESSION['poziceUzivatele'] == "Administrátor")  //kontrola zdali ukol, ke kteremu pristupujeme pres url byl pripsan uzivateli jenz je prihlasen.
         {
           $idUkol=$row['idUkolu'];
           $idObjednavka=$row['id'];
            ...
            <div class="kalendarContainer">
                ...
                <div class="row py-lg-5" style="margin-right:0px;">
                  ...
                  <div class="card-footer" style="text-align:right;">';
                    ...
                    <!-- Button trigger modal B-->
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalLongB">
                  ...
                  echo '    
                        ...
                        <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle">Jste si jistí, že chcete objednávku schválit?</h5>
                              </div>
                              <div class="modal-body">
                                Před tím než kliknete na tlačítko <b>schválit</b>, se ujistěte, že jste vše řádně pročetl/a a že se vším souhlasíte.<br><br>Vaše změny nebude možné vrátit zpět!
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Zavřít</button>
                                <form method="POST" action="../scripts/objednavkascr">
                                    <input type="hidden" name="idUkoluHidden" value="'.$idUkol.'">
                                    <input type="hidden" name="idObjednavkyHidden" value="'.$idObjednavky.'">
                                    <button type="submit" name="schvalitSubmit" class="btn btn-success">Schválit</button>
                                </form>
                              </div>
                            </div>
                          </div>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalLongB" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitleB" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle">Jste si jistí, že chcete objednávku zamítnout?</h5>
                              </div>
                              <div class="modal-body">
                                 Před tím než kliknete na tlačítko <b>zamítnout</b>, se ujistěte, že jste vše řádně pročetl/a a že jste opravdu rozhodnut pro zamítnutí<br><br>Vaše změny nebude možné vrátit zpět!
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Zavřít</button>
                                <form method="POST" action="../scripts/objednavkascr">
                                    <input type="hidden" name="idUkoluHidden" value="'.$idUkol.'">
                                    <input type="hidden" name="idObjednavkyHidden" value="'.$idObjednavky.'">
                                    <button type="submit" name="zamitnoutSubmit" class="btn btn-danger">Zamítnout</button>
                                </form>
                              </div>
                            </div>
                          </div>
